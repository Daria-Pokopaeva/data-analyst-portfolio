...
**`Проект 1`** Dashboard по кадровому резерву (Excel) <br/>
...
**`Проект 2`** База с автоматическим поиском открытых и закрытых вакансий (Excel)<br/>
...
**`Проект 3`** Моделирование изменения балансов студентов (Google Sheets)<br/>
**Задачи:** 
...
**`Проект 4`** Моделирование изменения балансов студентов (SQL)<br/>
