...
**Какое решение реализовано:** ([ССЫЛКА на калькулятор](https://docs.google.com/spreadsheets/d/1ulFr18UkjfJJOPd9dX-d_mUUBTcp3lif/edit#gid=2115260105)).
...
**Какое решение реализовано:** ([ССЫЛКА на запрос и визуализацию](https://docs.google.com/document/d/1fx1BtBvl18P9u4kssKWPRDsqv3WRJl3PSfWpC11Q_Ds/edit ))
**Комментарий:** проект является частью курсовой работы, выполненной в ходе обучения на аналитика данных. 
